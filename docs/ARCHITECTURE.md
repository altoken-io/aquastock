...
- `apps/dapp` — the actual product surface: wallet-connect, browse projects, fund a position, view milestones, "My Impact." Currently a placeholder home page only (`src/app/[locale]/page.tsx` + `components/dapp-shell.tsx`) — the real screens are Day 1-3 work.
