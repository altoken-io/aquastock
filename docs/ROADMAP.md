...
**Status:** complete. What's _not_ done yet, explicitly: the Anchor program, wallet-connect, real project/dashboard UI, Solana Pay, and final marketing copy — all below.
