...
export function DialogContent({
  ...
  return (
    <BaseDialog.Portal>
      ...
      <BaseDialog.Popup
        className={cn(
          'fixed top-1/2 left-1/2 z-50 max-h-[calc(100dvh-2rem)] w-[min(420px,calc(100vw-2rem))] -translate-x-1/2 overflow-y-auto overscroll-contain -translate-y-1/2 rounded-xl border border-border/85 bg-card p-5 text-card-foreground shadow-xl outline-none transition-all duration-150 data-[ending-style]:scale-95 data-[ending-style]:opacity-0 data-[starting-style]:scale-95 data-[starting-style]:opacity-0',
          className,
        )}
      >
        {children}
