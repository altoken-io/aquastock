  ...
  'max-sm:text-sm relative inline-flex items-center justify-center gap-2 whitespace-nowrap transition ease-in-out text-nowrap cursor-pointer select-none outline-none focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-disabled:pointer-events-none aria-disabled:opacity-50 aria-disabled:shadow-sm aria-disabled:hover:shadow-none aria-invalid:border-red-500 aria-invalid:ring-red-500/20 dark:aria-invalid:ring-red-800/40',
  {
    variants: {
      variant: {
        none: '',
        gradient:
          'bg-gradient-to-r text-white from-emerald-600 to-teal-600 hover:bg-gradient-to-r hover:from-emerald-700 hover:to-teal-700 active:bg-gradient-to-r active:from-emerald-800 active:to-teal-800 shadow-sm rounded-md',
        solid:
        ...
        outline:
          'bg-transparent border border-neutral-300/75 dark:border-neutral-700/75 shadow-none! rounded-md hover:bg-neutral-100 active:bg-neutral-200 dark:hover:bg-neutral-800 dark:active:bg-neutral-900',
        ...
        linkText:
          'p-0! m-0! shadow-none! text-neutral-950/75 dark:text-neutral-50/75 dark:hover:text-emerald-600/75 dark:active:text-emerald-600/75 hover:text-emerald-600/75 active:text-emerald-600/75',
        danger:
