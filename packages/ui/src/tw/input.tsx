...
const defaultClassName = cn(
  ...
  'focus-visible:ring-emerald-400/75 dark:focus-visible:ring-emerald-600/75',
  'placeholder:text-neutral-400/75 dark:placeholder:text-neutral-600/75',
  'touch-manipulation selection:bg-emerald-200/75 dark:selection:bg-emerald-900/75',
  ...
  'hover:shadow-sm hover:shadow-emerald-500/40',
  'active:shadow-md active:shadow-emerald-500/60',
      ...
      <div className={cn('relative flex flex-col gap-2', parentClassName)}>
        ...
        >
          ...
          {type === 'password' && (
            <button
              type="button"
              className="absolute right-1 top-1/2 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-md text-neutral-500 transition hover:text-neutral-700 focus-visible:outline-none focus-visible:ring focus-visible:ring-emerald-400/60 dark:text-neutral-400 dark:hover:text-neutral-200"
