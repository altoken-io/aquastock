...
const ContactForm = ({ className, ...props }: ContactFormProps) => {
  ...
  return (
    <div className="relative flex min-h-[calc(100vh-8rem)] flex-col gap-6 bg-linear-to-b from-primary/5 to-white/50 px-4 pt-24 pb-36 dark:from-neutral-950 dark:to-primary/10">
      <div className="mx-auto flex max-w-4xl grow flex-col justify-center gap-12">
        <div className="flex flex-col gap-2">
          <MotionInViewH1
            delay={0.2}
            className="flex w-fit items-center gap-2 rounded-full border border-primary/30 bg-primary/10 px-4 py-2 text-primary-pressed backdrop-blur-sm max-md:text-sm dark:text-primary"
          >
