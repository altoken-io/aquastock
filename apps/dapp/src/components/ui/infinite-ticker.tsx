...
export const InfiniteTicker = ({
  ...
  return (
    <div
      ...
      style={{
        maskImage: `linear-gradient(to right, transparent, ${fadeColor} 20%, ${fadeColor} 80%, transparent)`,
        WebkitMaskImage: `linear-gradient(to right, transparent, ${fadeColor} 20%, ${fadeColor} 80%, transparent)`,
      }}
    >
